...
class __TwigTemplate_fa9bc3b53028f3bad76ee04e3d446e8f8f6e4a0ec7a93e59eef423a9f245f4f8 extends Twig_Template
{
...
";
        ...
        if (twig_trim_filter(($context["html"] ?? null))) {
            ...
            if ($this->getAttribute($this->getAttribute(($context["segment"] ?? null), "attributes", array()), "id", array())) {
                echo "id=\"";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["segment"] ?? null), "attributes", array()), "id", array()), "html", null, true);
                echo "\" ";
            }
            echo "class=\"";
...
";
    ...
    {
        return new Twig_Source("", "@nucleus/layout/block.html.twig", "/var/www/html/media/gantry5/engines/nucleus/templates/layout/block.html.twig");
    }
}
