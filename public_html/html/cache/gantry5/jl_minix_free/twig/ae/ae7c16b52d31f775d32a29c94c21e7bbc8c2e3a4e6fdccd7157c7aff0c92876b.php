...
class __TwigTemplate_08e9c57e019234a94489d4990a2afc45dc432a35461ba118dd0b8cc73d69a12e extends Twig_Template
{
...
";
        ...
        if (twig_trim_filter(($context["html"] ?? null))) {
            // line 17
            echo "    <div class=\"";
            echo twig_escape_filter($this->env, (($context["class"] ?? null) . (($this->getAttribute($this->getAttribute(($context["segment"] ?? null), "attributes", array()), "class", array())) ? ((" " . twig_join_filter($this->getAttribute($this->getAttribute(($context["segment"] ?? null), "attributes", array()), "class", array()), " "))) : (""))), "html", null, true);
            echo "\">
        ";
            // line 18
...
";
    ...
    {
        return new Twig_Source("", "@nucleus/content/system.html.twig", "/var/www/html/media/gantry5/engines/nucleus/templates/content/system.html.twig");
    }
}
