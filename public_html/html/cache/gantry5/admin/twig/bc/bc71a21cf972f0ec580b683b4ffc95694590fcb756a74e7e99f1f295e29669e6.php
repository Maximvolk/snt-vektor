...
class __TwigTemplate_7c358f5962a76ea7400971c51fc05e61c69ef68ced76eda9f178d4914799e151 extends Twig_Template
{
    ...
    <option value=\"default\"
        ...
        // line 4
        echo "            data-data=\"";
        echo twig_escape_filter($this->env, twig_jsonencode_filter(array("params" => array("navbar" => true), "url" => $this->getAttribute(($context["gantry"] ?? null), "route", array(0 => "configurations/default", 1 => (((isset($context["configuration_page"]) || array_key_exists("configuration_page", $context))) ? (_twig_default_filter(($context["configuration_page"] ?? null), "styles")) : ("styles"))), "method"))), "html_attr");
        echo "\">
        ";
        // line 5
...
";
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["name"] => $context["title"]) {
                ...
                // line 19
                echo "                    data-data=\"";
                echo twig_escape_filter($this->env, twig_jsonencode_filter(array("params" => array("navbar" => true), "url" => $this->getAttribute(($context["gantry"] ?? null), "route", array(0 => "configurations", 1 => twig_escape_filter($this->env, $context["name"]), 2 => (((isset($context["configuration_page"]) || array_key_exists("configuration_page", $context))) ? (_twig_default_filter(($context["configuration_page"] ?? null), "styles")) : ("styles"))), "method"))), "html_attr");
                echo "\"
            >
                ";
                // line 21
...
";
    ...
    {
        return new Twig_Source("", "partials/outlines-list.html.twig", "/var/www/html/administrator/components/com_gantry5/templates/partials/outlines-list.html.twig");
    }
}
