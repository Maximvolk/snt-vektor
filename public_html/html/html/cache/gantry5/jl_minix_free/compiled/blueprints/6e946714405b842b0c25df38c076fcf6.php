...
return [
    ...
    'timestamp' => 1539151387,
    'checksum' => '1668b31f14bbd508a72dc3e27bb7d7d7',
    'files' => [
        'templates/jl_minix_free/custom/particles' => [
            'particles/backtotop' => [
                'file' => 'templates/jl_minix_free/custom/particles/backtotop.yaml',
                'modified' => 1539151379
            ],
            'particles/sticky' => [
                'file' => 'templates/jl_minix_free/custom/particles/sticky.yaml',
                'modified' => 1539151379
            ]
        ],
        'templates/jl_minix_free/particles' => [
            'particles/offcanvas-toggle' => [
                'file' => 'templates/jl_minix_free/particles/offcanvas-toggle.yaml',
                'modified' => 1539151380
            ]
        ],
        ...
        'templates/jl_minix_free/blueprints' => [
            'page' => [
                'file' => 'templates/jl_minix_free/blueprints/page.yaml',
                'modified' => 1539151379
            ],
            'styles/accent' => [
                'file' => 'templates/jl_minix_free/blueprints/styles/accent.yaml',
                'modified' => 1539151379
            ],
            'styles/base' => [
                'file' => 'templates/jl_minix_free/blueprints/styles/base.yaml',
                'modified' => 1539151379
            ],
            'styles/breadcrumbs' => [
                'file' => 'templates/jl_minix_free/blueprints/styles/breadcrumbs.yaml',
                'modified' => 1539151379
            ],
            'styles/breakpoints' => [
                'file' => 'templates/jl_minix_free/blueprints/styles/breakpoints.yaml',
                'modified' => 1539151379
            ],
            'styles/font' => [
                'file' => 'templates/jl_minix_free/blueprints/styles/font.yaml',
                'modified' => 1539151379
            ],
            'styles/footer' => [
                'file' => 'templates/jl_minix_free/blueprints/styles/footer.yaml',
                'modified' => 1539151379
            ],
            'styles/main' => [
                'file' => 'templates/jl_minix_free/blueprints/styles/main.yaml',
                'modified' => 1539151379
            ],
            'styles/menu' => [
                'file' => 'templates/jl_minix_free/blueprints/styles/menu.yaml',
                'modified' => 1539151379
            ],
            'styles/menustyle' => [
                'file' => 'templates/jl_minix_free/blueprints/styles/menustyle.yaml',
                'modified' => 1539151379
            ],
            'styles/navigation' => [
                'file' => 'templates/jl_minix_free/blueprints/styles/navigation.yaml',
                'modified' => 1539151379
            ],
            'styles/offcanvas' => [
                'file' => 'templates/jl_minix_free/blueprints/styles/offcanvas.yaml',
                'modified' => 1539151379
            ]
        ],
    ...
    'data' => [
        'items' => [
            ...
            'particles.backtotop.enabled' => [
                'type' => 'input.checkbox',
                'label' => 'Enabled',
                'description' => 'Globally enable to the particles.',
                'default' => true,
                'name' => 'particles.backtotop.enabled'
            ],
            'particles.backtotop.css' => [
                'type' => '_parent',
                'name' => 'particles.backtotop.css',
                'form_field' => false
            ],
            'particles.backtotop.css.class' => [
                'type' => 'input.text',
                'label' => 'Class',
                'description' => 'CSS class name for the particle.',
                'name' => 'particles.backtotop.css.class'
            ],
            'particles.backtotop.icon' => [
                'type' => 'input.icon',
                'label' => 'Back to top icon',
                'description' => 'Choose icon back to top.',
                'default' => 'fa fa-angle-double-up',
                'name' => 'particles.backtotop.icon'
            ],
            'particles.sticky' => [
                'type' => '_root',
                'form_field' => false,
            ...
            'particles.sticky.enabled' => [
                'type' => 'input.checkbox',
                'label' => 'Enabled',
                'description' => 'Globally enable to the particles.',
                'default' => true,
                'name' => 'particles.sticky.enabled'
            ],
            'particles.sticky.id' => [
                'type' => 'input.text',
                'label' => 'Sticky element',
                'description' => 'Sticky element id',
                'name' => 'particles.sticky.id'
            ],
            'particles.sticky.spacing' => [
                'type' => 'input.number',
                'label' => 'Spacing',
                'default' => 0,
                'description' => 'Enter spacing to top(px).',
                'name' => 'particles.sticky.spacing'
            ],
            'particles.offcanvas-toggle' => [
                'type' => '_root',
                'form_field' => false,
            ...
            'styles.breadcrumbs.background' => [
                'type' => 'input.colorpicker',
                'label' => 'Background',
                'default' => '#141414',
                'name' => 'styles.breadcrumbs.background'
            ],
            'styles.breadcrumbs.text-color' => [
                'type' => 'input.colorpicker',
                'label' => 'Text',
                'default' => '#ffffff',
                'name' => 'styles.breadcrumbs.text-color'
            ],
            'styles.breakpoints' => [
                'type' => '_root',
                'form_field' => false,
        ...
        'nested' => [
            'particles' => [
                'backtotop' => [
                    'enabled' => 'particles.backtotop.enabled',
                    'css' => [
                        'class' => 'particles.backtotop.css.class'
                    ],
                    'icon' => 'particles.backtotop.icon'
                ],
                'sticky' => [
                    'enabled' => 'particles.sticky.enabled',
                    'id' => 'particles.sticky.id',
                    'spacing' => 'particles.sticky.spacing'
                ],
                'offcanvas-toggle' => [
            ...
            'styles' => [
                ...
                'breadcrumbs' => [
                    'background' => 'styles.breadcrumbs.background',
                    'text-color' => 'styles.breadcrumbs.text-color'
                ],
                'breakpoints' => [
